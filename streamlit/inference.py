...
class ModelInference:
    ...
    def generate(self, medical_text: str) -> InferenceResult:
        ...
        # El modelo compilado ya tiene el prompt integrado, solo pasamos el texto
        ...
        # Extraer solo la parte simplificada (remover el input original si está incluido)
        simplified_text = full_text.replace(medical_text, "").strip()
        if not simplified_text:
            # Si el texto está vacío después de la limpieza, usar el texto completo
